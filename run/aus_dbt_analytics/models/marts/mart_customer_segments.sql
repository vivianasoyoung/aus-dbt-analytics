  ...
  create  table "aus_pipeline"."analytics_dev_marts"."mart_customer_segments__dbt_tmp"
...
with monthly as (
    select * from "aus_pipeline"."analytics_dev_intermediate"."int_customer_monthly_spend"
),
